...
from tensorflow.keras.layers import Dense, Bidirectional, LSTM, GRU, SimpleRNN, RepeatVector, TimeDistributed
...
class RunModel:
    ...
    def rnn_model(self):
        ...
        hist = model_rnn.fit(self.X_train, self.y_train, epochs=5, validation_split=0.2, batch_size=100)
    ...
    def lstm_model(self):
        ...
        model_lstm.add(LSTM(50, activation='relu', input_shape=(6, 1), return_sequences=True))
        ...
        hist = model_lstm.fit(self.X_train, self.y_train, epochs=5, validation_split=0.2, batch_size=100)
    ...
    def gru_model(self):
        ...
        hist = model_gru.fit(self.X_train, self.y_train, epochs=5, validation_split=0.2, batch_size=100)
    ...
    def cnn_lstm_model(self):
        ...
        model_cnn_lstm.add(tf.keras.layers.Conv1D(32, 2, activation='relu', input_shape=(6,1)))
        ...
        hist = model_cnn_lstm.fit(self.X_train, self.y_train, epochs=5, validation_split=0.2, batch_size=100)
